export const frbContent = {
    ...
    startDate: "2019",
    endDate: "2023",
    intro: "Modernized a legacy CRM into an ML-powered, 360° banking platform used by 4000+ bankers, boosting engagement by 20%, accelerating lead conversion, and helping recover $5B in deposits. Scaled a bank-wide design system that cut UI defects by 30% and sped release cycles by 20%. Led change-management campaigns to drive adoption and executive alignment.",
    projects: [
        {
