export const chefClaudeContent = {
    ...
    designChallenges: {
        ...
        challenges: [
            ...
            {
                subtTitle: "MVP Architecture Choices",
                decisions: [
                    "To move fast without infrastructure overhead, I implemented localStorage persistence for favorites. This gave users continuity without requiring a backend, striking the right balance for a rapid prototype."
                ],
                gif:"",
            }       
        ]
    ...
    uxFlow: {
        sectionTitle: "UX Flow",
        steps: [
            {
                stepTitle: "Start typing",
                step: "Input auto-focus means no extra click.",
            },
            {
                stepTitle: "Get your recipe",
                description: "Claude generates a structured recipe + witty description while DALL·E 3 creates a visual.",
            },
            {
                title: "Save to favorites",
                description: "Recipes persist locally in interactive cards, allowing you to revisit them anytime.",   
            }
        ],
        gif:"",
    },    
    outcome: {
        ...
        outcomes: [
            "Live, functional app that transforms pantry inputs into recipes with appealing visuals and polished UX.",
            "Tested with 8 early users (friends & family) → 50+ recipes generated in the first week. Feedback highlighted delight in witty loading states, humorous handling of non-edibles, and the ability to save unlimited favorites.",
            "Demonstrates my ability to design, prototype, and ship AI-powered products end-to-end.",
            "Serves as a rapid prototyping model for future AI concepts, bridging product design, engineering constraints, and user delight."
        ],
        img:"",
    },
    closing: {
