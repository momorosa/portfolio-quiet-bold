...
export default function Footer({ className = "" }) {
    return (
        <footer
            className={`border-t border-[var(--border)] bg-transparent px-6 py-6 text-sm text-[var    (--text-soft)] md:px-10 lg:px-14 ${className}`}
        >
            <div className="mx-auto max-w-[1440px]">
                <div className="md:hidden">
                    <div className="flex items-center justify-between gap-4">
                        <QuietBoldHomeLink mobile />
                        <Social
                            direction="row"
                            gap={6}
                            size={21}
                            baseColor="var(--text-soft)"
                    ...
                    <p className="mt-4 text-center leading-relaxed">
                        ©2026 - Rosa Choi.{" "}
                        <FancyLink href="https://github.com/momorosa/portfolio-quiet-bold">
                ...
                <div className="hidden md:grid md:grid-cols-[auto_1fr_auto] md:items-center md:gap-6">
                    <div className="justify-self-start">
                        <QuietBoldHomeLink size="1.25em" />
                    </div>

                    <p className="justify-self-center text-center leading-relaxed">
                        ©2026 - Rosa Choi.{" "}
                        <FancyLink href="https://github.com/momorosa/portfolio-quiet-bold">
                            Crafted with Endless Curiosity.
                        </FancyLink>
