...
const EMAIL_D1 = "M1.5 8.67v8.58a3 3 0 0 0 3 3h15a3 3 0 0 0 3-3V8.67l-8.928 5.493a3 3 0 0 1-3.144 0L1.5 8.67Z"
const EMAIL_D2 = "M22.5 6.908V6.75a3 3 0 0 0-3-3h-15a3 3 0 0 0-3 3v.158l9.714 5.978a1.5 1.5 0 0 0 1.572 0L22.5 6.908Z"
...
export default function Social({
    ...
    links = [
        ...
        // {
        //     href: mailto("momorosa.design@gmail.com", "Quick hello from your website visitor 👋",
        //          "Hey Rosa, I found your portfolio and..."),
        //     label: "Email",
        //     viewBox: "0 0 24 24",
        //     paths: [EMAIL_D1, EMAIL_D2],
        // },
    ...
    return (
        <div className={`flex ${dirClasses} items-center`} style={{ gap }}>
            {links.map((item) => (
                <SocialIcon
                    key={item.href}
                    {...item}
...
function SocialIcon({
  ...
  // Anchor only controls opacity mode so the hit area doesn’t scale
    const linkHover =
        hoverMode === "opacity"
            ? { opacity: 0.6 }
            : { opacity: 1 }
